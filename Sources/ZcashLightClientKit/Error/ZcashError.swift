...
public enum ZcashError: Equatable, Error {
    ...
    public var message: String {
        ...
        case .rustGetAccountForTransparentAddress: return "Error from rust layer when calling ZcashRustBackend.getAccount(forTransparentAddress:)"
    ...
    public var code: ZcashErrorCode {
        ...
        case .rustGetAccountForTransparentAddress: return .rustGetAccountForTransparentAddress
