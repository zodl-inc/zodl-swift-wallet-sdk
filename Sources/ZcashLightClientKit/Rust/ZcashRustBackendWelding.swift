...
protocol ZcashRustBackendWelding {
    ...
    /// `nil` when no account of the wallet did.
    /// - parameter address: the transparent address to look up.
    /// - Throws:
    ///     - `rustGetAccountForTransparentAddress` if rust layer returns error.
