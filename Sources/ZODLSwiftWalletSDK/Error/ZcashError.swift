...
public enum ZcashError: Equatable, Error {
    ...
    public var message: String {
        ...
        case .rustProposeTransferFromURI: return "Error from rust layer when calling ZcashRustBackend.proposeTransferFromURI"
        ...
        case .rustPutIronwoodSubtreeRootsAllocationProblem: return "Unable to allocate memory required to write blocks when calling ZcashRustBackend.putIronwoodSubtreeRoots"
        case .rustPutIronwoodSubtreeRoots: return "Error from rust layer when calling ZcashRustBackend.putIronwoodSubtreeRoots"
        case .rustGetTransaction: return "Error from rust layer when calling ZcashRustBackend.getTransaction"
        case .rustProposeTransfer: return "Error from rust layer when calling ZcashRustBackend.proposeTransfer"
        case .rustProposeOrchardToIronwoodMigration: return "Error from rust layer when calling ZcashRustBackend.proposeOrchardToIronwoodMigration"
        case .rustProposalScanRequired: return "The wallet must finish scanning the blockchain before this payment can be prepared."
        case .rustProposalInsufficientFunds: return "The spendable balance does not cover this payment and its fee."
        ...
        case .rustSetTransactionStatus: return "Error from rust layer when calling ZcashRustBackend.setTransactionStatus"
        ...
        case .rustDeleteAccount: return "Error from rust layer when calling ZcashRustBackend.deleteAccount"
        case .rustTruncateToChainState: return "Error from rust layer when calling ZcashRustBackend.truncateToChainState"
        case .rustEip681Parse: return "Error from rust layer when calling ZcashEip681Backend.parseTransactionRequest"
        case .rustSlipstreamOpen: return "Failed to open the Slipstream engine handle via zcashlc_slipstream_open."
        ...
        case .slipstreamEngineNotQuiescent: return "The engine could not prove its previous pass and wallet writer had stopped before a wallet mutation; the mutation was refused."
        case .rustMigrationProgress: return "Error from rust layer when calling ZcashRustBackend.migrationProgress"
        case .rustMigrationIsNoteSplitNeeded: return "Error from rust layer when calling ZcashRustBackend.migrationIsNoteSplitNeeded"
        case .rustMigrationHasOverdueTransfers: return "Error from rust layer when calling ZcashRustBackend.migrationHasOverdueTransfers"
        case .rustMigrationHasInvalidTransfers: return "Error from rust layer when calling ZcashRustBackend.migrationHasInvalidTransfers"
        case .rustMigrationPrepareNoteSplit: return "Error from rust layer when calling ZcashRustBackend.migrationPrepareNoteSplit"
        case .rustMigrationSignNoteSplit: return "Error from rust layer when calling ZcashRustBackend.migrationSignNoteSplit"
        case .rustMigrationResidualAfterMigration: return "Error from rust layer when calling ZcashRustBackend.migrationResidualAfterMigration"
        case .rustMigrationProposeTransfers: return "Error from rust layer when calling ZcashRustBackend.migrationProposeTransfers"
        case .rustMigrationSignAndStoreSchedule: return "Error from rust layer when calling ZcashRustBackend.migrationSignAndStoreSchedule"
        case .rustMigrationTakeBroadcastTransaction: return "Error from rust layer when calling ZcashRustBackend.migrationTakeBroadcastTransaction"
        case .rustMigrationTakePreparation: return "Error from rust layer when calling ZcashRustBackend.migrationTakePreparation"
        case .rustMigrationRecordTransferResult: return "Error from rust layer when calling ZcashRustBackend.migrationRecordTransferResult"
        case .rustMigrationRestartStep: return "Error from rust layer when calling ZcashRustBackend.migrationRestartStep"
        case .rustMigrationRefreshStaleTransfers: return "Error from rust layer when calling ZcashRustBackend.migrationRefreshStaleTransfers"
        case .rustMigrationCreateUnsignedNoteSplitPczt: return "Error from rust layer when calling ZcashRustBackend.migrationCreateUnsignedNoteSplitPczt"
        case .rustMigrationStoreSignedNoteSplitPczt: return "Error from rust layer when calling ZcashRustBackend.migrationStoreSignedNoteSplitPczt"
        ...
        case .rustProposeSendMaxTransfer: return "Error from rust layer when calling ZcashRustBackend.proposeSendMaxTransfer"
        case .migrationRecordImmediateRunInvalidTxId: return "`migrationRecordImmediateRun` was called with a `txid` that is not exactly 32 bytes."
        case .rustMigrationRecordImmediateRun: return "Error from rust layer when calling ZcashRustBackend.migrationRecordImmediateRun"
        case .rustMigrationLockResidual: return "Error from rust layer when calling ZcashRustBackend.lockMigrationResidual"
        case .rustMigrationUnlockResidual: return "Error from rust layer when calling ZcashRustBackend.unlockMigrationResidual"
        case .rustMigrationEstimateRuns: return "Error from rust layer when calling ZcashRustBackend.estimateMigrationRuns"
        case .rustMigrationTransactionStatuses: return "Error from rust layer when calling ZcashRustBackend.migrationTransactionStatuses"
        case .rustMigrationKeystoneBuildSignBatchQrParts: return "Error from rust layer when calling ZcashRustBackend.migrationKeystoneBuildSignBatchQrParts"
        case .rustMigrationKeystoneDecodeSignBatchPart: return "Error from rust layer when calling ZcashRustBackend.migrationKeystoneDecodeSignBatchPart"
        case .rustMigrationKeystoneApplyBatchSignatures: return "Error from rust layer when calling ZcashRustBackend.migrationKeystoneApplyBatchSignatures"
        case .rustMigrationProveTransactions: return "Error from rust layer when calling ZcashRustBackend.migrationProveTransactions"
        case .migrationWakeupInfeasible: return "A stored migration transfer admits NO valid sync/proving wake-up height."
        case .rustMigrationAdvanceStep: return "Error from rust layer when calling ZcashRustBackend.migrationAdvanceStep"
        case .rustMigrationSyncWakeups: return "Error from rust layer when calling ZcashRustBackend.migrationSyncWakeups"
        case .rustMigrationBlockRateSamples: return "Error from rust layer when calling ZcashRustBackend.migrationBlockRateSamples"
        case .rustMigrationReconcileUnrecordedBroadcasts: return "Error from rust layer when calling ZcashRustBackend.migrationReconcileUnrecordedBroadcasts"
        case .rustMigrationBatchPcztsByActions: return "Error from rust layer when calling ZcashRustBackend.migrationBatchPcztsByActions"
        case .migrationChainTipUnavailable: return "No chain tip is available to estimate from: the wallet has never scanned a block."
        ...
        case .compactBlockProcessorServerMissingIronwoodSupport: return "The chain is past the Ironwood (NU6.3) activation but the connected server does not serve Ironwood data, which the wallet needs in order to detect its shielded transactions by scanning."
    ...
    /// The redacted detail carried by this error, if any.
    ///
    /// Only a `RedactedRustError` payload is rendered here. That is the whole point of the type:
    /// a raw `String` from `lastErrorMessage(fallback:)` may still hold an amount or an address,
    /// so it must not reach `errorDescription` and from there an error report. Widening this to
    /// other payload types means redacting them at the rust boundary first.
    public var detail: String? {
        switch self {
        case .rustCreateToAddress(let rustError): return rustError.message
        case .rustProposeTransferFromURI(let rustError): return rustError.message
        case .rustProposeTransfer(let rustError): return rustError.message
        case .rustProposeOrchardToIronwoodMigration(let rustError): return rustError.message
        case .rustProposeSendMaxTransfer(let rustError): return rustError.message
        default: return nil
        }
    }
    ...
    public var code: ZcashErrorCode {
        ...
        case .rustPutIronwoodSubtreeRootsAllocationProblem: return .rustPutIronwoodSubtreeRootsAllocationProblem
        case .rustPutIronwoodSubtreeRoots: return .rustPutIronwoodSubtreeRoots
        case .rustGetTransaction: return .rustGetTransaction
        case .rustProposeTransfer: return .rustProposeTransfer
        case .rustProposeOrchardToIronwoodMigration: return .rustProposeOrchardToIronwoodMigration
        case .rustProposalScanRequired: return .rustProposalScanRequired
        case .rustProposalInsufficientFunds: return .rustProposalInsufficientFunds
        ...
        case .rustSetTransactionStatus: return .rustSetTransactionStatus
        ...
        case .slipstreamEngineNotQuiescent: return .slipstreamEngineNotQuiescent
        case .rustMigrationProgress: return .rustMigrationProgress
        case .rustMigrationIsNoteSplitNeeded: return .rustMigrationIsNoteSplitNeeded
        case .rustMigrationHasOverdueTransfers: return .rustMigrationHasOverdueTransfers
        case .rustMigrationHasInvalidTransfers: return .rustMigrationHasInvalidTransfers
        case .rustMigrationPrepareNoteSplit: return .rustMigrationPrepareNoteSplit
        case .rustMigrationSignNoteSplit: return .rustMigrationSignNoteSplit
        case .rustMigrationResidualAfterMigration: return .rustMigrationResidualAfterMigration
        case .rustMigrationProposeTransfers: return .rustMigrationProposeTransfers
        case .rustMigrationSignAndStoreSchedule: return .rustMigrationSignAndStoreSchedule
        case .rustMigrationTakeBroadcastTransaction: return .rustMigrationTakeBroadcastTransaction
        case .rustMigrationTakePreparation: return .rustMigrationTakePreparation
        case .rustMigrationRecordTransferResult: return .rustMigrationRecordTransferResult
        case .rustMigrationRestartStep: return .rustMigrationRestartStep
        case .rustMigrationRefreshStaleTransfers: return .rustMigrationRefreshStaleTransfers
        case .rustMigrationCreateUnsignedNoteSplitPczt: return .rustMigrationCreateUnsignedNoteSplitPczt
        case .rustMigrationStoreSignedNoteSplitPczt: return .rustMigrationStoreSignedNoteSplitPczt
        ...
        case .rustProposeSendMaxTransfer: return .rustProposeSendMaxTransfer
        case .migrationRecordImmediateRunInvalidTxId: return .migrationRecordImmediateRunInvalidTxId
        case .rustMigrationRecordImmediateRun: return .rustMigrationRecordImmediateRun
        case .rustMigrationLockResidual: return .rustMigrationLockResidual
        case .rustMigrationUnlockResidual: return .rustMigrationUnlockResidual
        case .rustMigrationEstimateRuns: return .rustMigrationEstimateRuns
        case .rustMigrationTransactionStatuses: return .rustMigrationTransactionStatuses
        case .rustMigrationKeystoneBuildSignBatchQrParts: return .rustMigrationKeystoneBuildSignBatchQrParts
        case .rustMigrationKeystoneDecodeSignBatchPart: return .rustMigrationKeystoneDecodeSignBatchPart
        case .rustMigrationKeystoneApplyBatchSignatures: return .rustMigrationKeystoneApplyBatchSignatures
        case .rustMigrationProveTransactions: return .rustMigrationProveTransactions
        case .migrationWakeupInfeasible: return .migrationWakeupInfeasible
        case .rustMigrationAdvanceStep: return .rustMigrationAdvanceStep
        case .rustMigrationSyncWakeups: return .rustMigrationSyncWakeups
        case .rustMigrationBlockRateSamples: return .rustMigrationBlockRateSamples
        case .rustMigrationReconcileUnrecordedBroadcasts: return .rustMigrationReconcileUnrecordedBroadcasts
        case .rustMigrationBatchPcztsByActions: return .rustMigrationBatchPcztsByActions
        case .migrationChainTipUnavailable: return .migrationChainTipUnavailable
        ...
        case .compactBlockProcessorServerMissingIronwoodSupport: return .compactBlockProcessorServerMissingIronwoodSupport
