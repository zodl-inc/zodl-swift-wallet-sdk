# iOS demo app 
This is a demo app that exercises code in https://github.com/zodl-inc/zodl-swift-wallet-sdk, which has all the iOS-related functionalities necessary to build a mobile Zcash shielded wallet. 
